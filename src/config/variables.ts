...
const results: ResultData[] = [
    ...
    },
    {
        ...
        name_en: 'Stable & Assertive Lover',
        score: {
            bravery: 40,
            patience: 30,
            ownership: 30,
